...
class QPT():
    ...
    def get_chi_LS_X(self,rho_in_list,proj_list):
        ...
        prob1.solve(solver=cp.SCS,eps=1e-5);  # , verbose=True#cp.SCScp.OSQP#,eps=1e-10 ,eps=1e-10 ,alpha=2.0 
    ...
    def get_noisy_proj_1(self,  chi_matrix):
        ...
        for j in range(3**N): #3^N groups of POVMs
            ...
            prob1.solve(solver=cp.SCS,eps=1e-5 );  # , verbose=True max_iters=50000,
